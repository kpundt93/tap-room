    ...
    <React.Fragment>
      <Form onSubmit={props.formSubmissionHandler}>
        <Form.Group className="col-6">
          ...
          <Form.Control type="text" name="name" placeholder="Keg Name" />
        </Form.Group>
        <Form.Group className="col-6">
          <Form.Label className="form-label">Alcohol content</Form.Label>
          <Form.Control type="number" step="0.01" name="abv" placeholder="ABV" min="0.0" max="15.0" />
        </Form.Group>
        <Form.Group className="col-6">
          <Form.Label className="form-label">Price</Form.Label>
          <Form.Control type="number" step="0.01" name="price" min="0.0" />
        </Form.Group>
        <Form.Group className="col-6">
